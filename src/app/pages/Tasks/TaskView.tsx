...
export default function TaskView ({ task }: { task: Task }) {
  ...
  return (
    <div className='relative w-full bg-white border border-gray-200 shadow-sm rounded-xl p-5 flex flex-col md:flex-row gap-6 transition'>
      {/* Левая часть */}
      <div className='flex-1'>
        ...
        <h2 className='text-sm text-gray-500 mt-1'>Дедлайн: {task.deadline}</h2>
