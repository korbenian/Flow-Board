...
export default function ProfileUser () {
  ...
  return (
    <div className='flex min-h-screen transition-colors duration-300 dark:text-white'>
      {/* Sidebar */}
      <aside className='w-64 border-r border-gray-200 dark:text-white transition-colors duration-300'>
        <Sidebar />
      </aside>
        ...
        {!isEditing ? (
          <>
            ...
            <section className='flex flex-col gap-6'>
              ...
              {/* Описание */}
              <div className='border border-gray-200 dark:text-white border-gray-700 rounded-xl p-5 shadow-sm'>
              ...
              <div className='flex gap-3'>
                ...
                <button
                  className='w-1/3 py-2 px-4 rounded-3xl font-medium bg-amber-500 hover:bg-amber-600 text-white shadow-sm hover:shadow-md transition-colors duration-300'
            ...
            <section className='mt-10'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-5 w-[25rem]'>
                {tasks.filter(task => task.status === 'Done').length > 0 ? (
                  ...
                  <p className='text-sm opacity-80'>{t('noTasksDone')}</p>
                )}
              </div>
            </section>
          </>
