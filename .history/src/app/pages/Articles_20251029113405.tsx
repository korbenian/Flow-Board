...
export default function ArticlesPage () {
  ...
  return (
    <div className='flex'>
      {/* Sidebar слева */}
      <div className='w-64 text-black dark:text-white border-amber-100 border-2'>
        <Sidebar />
      </div>
      ...
      <div className='flex-1 p-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {articles.map(article => (
            <div
              key={article.id}
              className='p-4 shadow-md rounded-lg bg-white cursor-pointer hover:shadow-lg transition'
