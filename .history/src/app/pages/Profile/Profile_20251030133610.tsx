...
export default function ProfileUser () {
  ...
  return (
    <div className='flex min-h-screen transition-colors duration-300 bg-white dark:bg-gray-900 text-gray-900 dark:text-white'>
      {/* Sidebar */}
      <aside className='w-64 border-r border-gray-200 dark:border-gray-700 transition-colors duration-300'>
        <Sidebar />
      </aside>
          ...
          <>
            ...
            <section className='flex flex-col gap-6'>
              ...
              <div className='flex flex-col items-start'>
                ...
                <div className='flex gap-3.5 font-medium  dark:text-white'>
              ...
              {/* Описание */}
              <div className=' dark:text-white border border-gray-200 dark:border-gray-700 rounded-xl p-5 shadow-sm'>
                ...
                {tasks.filter(task => task.status === 'Done').length > 0 ? (
                  tasks
                    ...
                    .map(task => (
                      <div
                        key={task.id}
                        className='bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-5 flex flex-col shadow-sm hover:shadow-md transition-shadow duration-300'
                      >
