...
export default function TaskView ({ task }: { task: Task }) {
  ...
  return (
    <div className='relative  w-full dark:text-white border border-gray-200 shadow-sm  rounded-xl p-5 flex flex-col md:flex-row gap-6 transition'>
      {/* Левая часть */}
      <div className='flex-1 text-black dark:text-white'>
        <div className='flex items-center justify-between  dark:text-white'>
          ...
          <select
            ...
            className='px-3 py-2 border dark:text-white rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none '
          >
