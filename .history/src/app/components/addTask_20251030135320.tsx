  ...
  return (
    <div className='flex  min-h-screen'>
      <div className='flex-1 p-6 '>
        {/* Панель фильтров */}
        <div className='flex items-center  gap-3 mb-6 b px-4 py-3 rounded-xl shadow-sm'>
          <input
            type='text'
        ...
        {/* Карточки */}
        <div className='space-y-4 dark:border-amber-50'>
          {filteredTasks.map(task => (
            <div
              key={task.id}
              className=' p-5 rounded-xl dark:border-e-amber-50 shadow hover:shadow-md transition'
            >
              {task.isEditing ? (
