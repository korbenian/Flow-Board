    ...
    <div className='h-screen w-full bg-[linear-gradient(135deg,#0f0c29,#302b63,#24243e)] flex flex-col'>
      ...
      <div className='flex flex-col items-center justify-center flex-grow gap-6'>
        ...
        <button
          ...
          className='w-[12%] px-6 py-3 bg-gray-900 text-white font-medium rounded-xl shadow-lg hover:bg-gray-800 active:scale-95 transition-all flex items-center gap-2 cursor-pointer'
        >
          <svg
        ...
        <button
          ...
          className='w-[20%] px-6 py-3 bg-white text-gray-800 font-medium rounded-xl shadow-lg hover:bg-gray-200 active:scale-95 transition-all flex items-center gap-2 cursor-pointer'
        >
          <svg
            xmlns='http://www.w3.org/2000/svg'
            viewBox='0 0 488 512'
